-- Migration: 20260919140000_calculator_towing_availability_decouple_source.sql
-- Description: Decouple purchase source from calculator availability so purchase source (Copart, IAAI, etc.)
-- does not filter US States, Pickup Locations, Loading Ports, or Towing Rates.
-- State availability and location counts are based purely on active pickup locations with active towing rates.
